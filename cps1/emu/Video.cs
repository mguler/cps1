...
namespace mame
{
    ...
    partial class Video
    {
        ...
        public static Timer.emu_timer scanline0_timer;
        ...
        public static void video_init()
        {
            ...
            switch (Machine.sBoard)
            {
                ...
                case "CPS-1(QSound)":
                    ...
                    Machine.FORM.m68000form.custom_callback = Machine.FORM.m68000form.custom_default;
                    switch (Machine.sName)
                    {
                        ...
                        case "wof3jsa":
                        case "sgyxz":
                            Video.video_eof_callback = CPS.video_eof_cps1_sgyxz;
                            Machine.FORM.m68000form.custom_callback = Machine.FORM.m68000form.custom_sgyxz;
                            break;
                        default:
                            break;
                    }
