...
namespace ui
{
    public partial class m68000Form : Form
    {
        ...
        public debug_delegate custom_callback;
        private bool bLogNew;
        public static int iStatus;
        private int PPCTill, PPC;
        ...
        public void custom_default()
        {
            
        }            
        public void custom_sgyxz()
        {
            if (PPC == 0x71ce)
            {
                CPS.bClear = false;
            }
            if (MC68000.m1.A[4].u32 == 0xff4000)
            {
                CPS.bClear = true;
            }
        }
