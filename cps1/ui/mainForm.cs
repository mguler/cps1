...
namespace ui
{
    public partial class mainForm : Form
    {
        ...
        {
            StreamReader sr1 = new StreamReader("cps1.ini");
            sr1.ReadLine();
        ...
        public void LoadRom()
        {
            ...
            if (Machine.bRom)
            {
                this.Text = "CPS1.NET: " + Machine.sDescription + " [" + Machine.sName + "]";
                Mame.init_machine();
                //Generic.nvram_load();
            }
            else
        ...
        private void InitLoadForm()
        {
            ...
            columnheader.Width = 120;
            loadform.listView1.Columns.Add(columnheader);
            IEnumerable<XElement> elements = XElement.Parse(mame.Properties.Resources.mame).Elements("game");
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            StreamWriter sw1 = new StreamWriter("cps1.ini", false);
