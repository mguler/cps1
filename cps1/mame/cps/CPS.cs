...
namespace mame
{
    public partial class CPS
    {
        ...
        public static byte m_control, m_seconds,m_minutes, m_hours, m_day, m_date, m_month, m_year, m_century;
        public static int m_offset_control,m_offset_seconds, m_offset_minutes,m_offset_hours, m_offset_day, m_offset_date, m_offset_month, m_offset_year, m_offset_century, m_offset_flags;
            ...
            if (Machine.bRom)
            {
                ...
                switch (Machine.sName)
                {
                    ...
                    case "wofcn":
                        ...
                        dswc = 0xff;
                        lsRange0 = new List<gfx_range>();
                        lsRange0.Add(new gfx_range(0x1000, 0x19bf, 0xf000));
                        lsRange0.Add(new gfx_range(0xd000, 0xdfff, 0));
                        lsRange0.Add(new gfx_range(0xe000, 0xe9bf, 0x2000));
                        lsRange1 = new List<gfx_range>();
                        lsRange1.Add(new gfx_range(0x0000, 0x7fff, 0));
                        lsRange2 = new List<gfx_range>();
                        lsRange2.Add(new gfx_range(0x0000, 0x1fff, 0));
