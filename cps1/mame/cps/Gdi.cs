...
namespace mame
{
    public partial class CPS
    {
        ...
        public static gettileDelegateG GetTilemapGDI0_callback;
        ...
        public static void GDIInit()
        {
            ...
            {
                case "wofcn":
                    GetTilemapGDI0_callback = GetTilemapGDI0_wofcn;
                    break;
                default:
                    GetTilemapGDI0_callback = GetTilemapGDI0;
                    break;
            }
            gettileDelegatesG = new gettileDelegateG[]{
                new gettileDelegateG(GetSpriteGDI),
                new gettileDelegateG(GetTilemapGDI0_callback),
        ...
        public static void GetHighGDI2()
        {
            ...
            //Tilemap.effective_rowscroll2();
            //Tilemap.effective_colscroll2();
