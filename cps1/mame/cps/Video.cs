...
namespace mame
{
    public partial class CPS
    {
        ...
        public static void cps1_cps_a_w(int add, byte data)
        {
            int offset = add / 2;
            if (add % 2 == 0)
            {
        ...
        public static void cps1_cps_a_w(int offset, ushort data)
        {
        ...
        public static ushort cps1_cps_b_r(int offset)
        {
        ...
        public static void cps1_cps_b_w(int offset, ushort data)
        {
        ...
        public static void cps1_gfxram_w(int offset)
        {
            int row, col;
        ...
        private static void cps1_render_layer(int layer)
        {
            switch (layer)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ttmap[0].tilemap_draw_primask_act(Tilemap.videovisarea, 0x20, 0);
                    break;
                case 2:
        ...
        public static void video_eof_cps1_sgyxz()
        {
            int i;
            cps1_get_video_base();
            for (i = 0; i < 0x400; i++)
            {
                cps1_buffered_obj[i] = (ushort)(Memory.mainram[0x4000 + i * 2] * 0x100 + Memory.mainram[0x4000 + i * 2 + 1]);
            }
            if (bClear)
            {
                Array.Clear(Memory.mainram, 0x4000, 0x800);
            }
            cps1_build_palette(cps1_base(CPS1_PALETTE_BASE, 0x0400));
        }
